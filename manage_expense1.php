            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active"><a href="manage_expense1.php">Manage expense</a></li>
                        </ul>
                    </li>
                ...
                <div class="container">
                    <div class="">
                        <div class="well clearfix">
                            <center>
                                <h1 style="color:DarkRed;">Income/Expenses Details</h1>
                            </center>
                                ...
                                <table class="table table-borderless table-striped table-earning" id="table">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align:center;">Expense Category</th>
                                            </tr>
                                            </tr>
                                            </tr>
                                        </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;"><?php echo $row['expensedate']; ?></td>
                                            <td style="text-align:center;"><?php echo 'RS-'.$row['expense']; ?></td>
                                            <td style="text-align:center;"><?php echo $row['expensecategory']; ?></td>
                                        </tr>
                                    ...
                                    function downloadPDF() {
                                        ...
                                        newWin.document.write('<html><head><title>Income/Expenses Details</title>');
