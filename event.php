            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active"><a href="event.php">Society Events</a></li>
                        </ul>
                    </li>
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                ...
                <center>
                    <h1 style="color:DarkRed;">Maintance Details</h1>
                </center>
        ...
        // Retrieving data from database
            $sql = "SELECT name, email, phone, subject, fromdate, fromtime, todate, totime FROM event ";
        ...
        ?>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["phone"]."</td><td>".$row["subject"]
                ."</td><td>".$row["fromdate"]."</td><td>".$row["fromtime"]."</td><td>".$row["todate"]."</td><td>".$row["totime"]."</td></tr>";
            }
            ?>
                </table>
