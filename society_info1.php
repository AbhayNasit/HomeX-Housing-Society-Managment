      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="blank1.php">Entry/Exit</a></li>
              <li><a href="blank1.php">Attendees</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="society_info1.php">Information</a></li>
            </ul>
          </li>
            ...
            <div class="project-wrapper">
              <div class="project">
                <div class="photo-wrapper">
                  <div class="photo">
                    <a class="fancybox" href="img/portfolio/2.jpg"><img class="img-responsive" src="img/portfolio/2.jpg" alt=""></a>
                  </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
            <div class="project-wrapper">
              <div class="project">
                <div class="photo-wrapper">
                  <div class="photo">
                    <a class="fancybox" href="img/portfolio/3.jpg"><img class="img-responsive" src="img/portfolio/3.jpg" alt=""></a>
                  </div>
                  <div class="overlay"></div>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
            <div class="project-wrapper">
              <div class="project">
                <div class="photo-wrapper">
                  <div class="photo">
                    <a class="fancybox" href="img/portfolio/4.jpg"><img class="img-responsive" src="img/portfolio/4.jpg" alt=""></a>
                  </div>
                  <div class="overlay"></div>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
            <div class="project-wrapper">
              <div class="project">
                <div class="photo-wrapper">
                  <div class="photo">
                    <a class="fancybox" href="img/portfolio/5.jpg"><img class="img-responsive" src="img/portfolio/5.jpg" alt=""></a>
                  </div>
                  <div class="overlay"></div>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
            <div class="project-wrapper">
              <div class="project">
                <div class="photo-wrapper">
                  <div class="photo">
                    <a class="fancybox" href="img/portfolio/6.jpg"><img class="img-responsive" src="img/portfolio/6.jpg" alt=""></a>
                  </div>
                  <div class="overlay"></div>
                </div>
              </div>
