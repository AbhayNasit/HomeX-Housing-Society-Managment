     ...
     <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.php"><img src="img/6.png" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="blank.php">New Visitor</a></li>
              <li><a href="blank.php">Manage Visitor</a></li>
              <li><a href="blank.php">Visitor Data</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
