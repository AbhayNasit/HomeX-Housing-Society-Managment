            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li class="active"><a href="Security1.php">Security Gurd Details</a></li>
                        </ul>
                    </li>
                ...
                <div class="container">
                    <div class="">
                        <div class="well clearfix">
                            <center>
                                <h1 style="color:DarkRed;">Security Gurd Details</h1>
                            </center>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" id="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th><img src="img/5.jpg" alt="Ramsing" height="100" width="100"></th>
                                                <th>Ramsing</th>
                                                <th>1234567891</th>
                                                <th>Day Gurd</th>
                                                <th>9, Anand Society,Harni Road, Near Hanuman Temple, Harni, Vadodara,
                                                    Gujarat
                                                    390022 </th>
                                            </tr>

                                            <tr>
                                                <th><img src="img/6.jpg" alt="Vansh" height="100" width="100"></th>
                                                <th>Kmalesh Ahuja</th>
                                                <th>1234567891</th>
                                                <th>Night Gurd</th>
                                                <th>4,Panigate Rd,Syedwada,Chhipwad,Vadodara,Gujarat 390006</th>
                                            </tr>
                                        </tbody>
                                    </table>
