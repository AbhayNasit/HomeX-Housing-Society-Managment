    ...
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li class="active"><a href="attendance_details.php">Attendance_Details</a></li>
                        </ul>
                    </li>
        ...
        *********************************************************************************************************************************************************** -->
        ...
        // Retrieving data from database
            $sql = "SELECT name, work, date, p_a FROM attendance ";
        ...
        ?>
                ...
                <div class="container">
                    <div class="">
                        <div class="well clearfix">
                            <center>
                                <h1 style="color:DarkRed;">Staff Details</h1>
                            </center>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        $search = $_POST['search'];
                        $sql = "SELECT name, work, date, p_a FROM attendance WHERE name LIKE '%$search%' OR work LIKE '%$search%' OR date LIKE '%$search%' OR p_a LIKE '%$search%'";
                        $result = mysqli_query($connection, $sql);
                        $i=0;
                        ...
                        ?>
                                    ...
                                    function downloadPDF() {
                                        ...
                                        newWin.document.write('<html><head><title>Staff Details</title>');
                                        ...
                                        newWin.document.write(
                                            '<body><center><h1 style="color:DarkRed;">Staff Details</h1></center>');
