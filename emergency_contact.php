  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="emergency_contact.php">Contact</a></li>
              <li><a href="Hospitals.php">Hospitals</a></li>
              <li><a href="Police_Station.php">Police Station</a></li>
              <li><a href="City_Department.php">City Department</a></li>
    ...
    <section id="main-content"><br> 
     ...
     <div class="wrapper">
        ...
        <div> <b style="text-align:left;">24-Hour Vadodara Services</b></div>
